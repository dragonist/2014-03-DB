...
/**
 * Servlet implementation class makeNewsServlet
 */
@WebServlet("/MakeNewsServlet")
public class MakeNewsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher rd = request.getRequestDispatcher("/home/news/makeNews.jsp");
